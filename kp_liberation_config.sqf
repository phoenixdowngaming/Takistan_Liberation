...
KP_liberation_cr_wounded_gain = 15;																				// Civil Reputation gain for providing medical assistance for wounded civilians.
...
KP_liberation_convoy_ambush_duration = 600;																	// Duration of the convoy ambush event. (seconds)
